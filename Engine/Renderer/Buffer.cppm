...
constexpr uint32_t ShaderDataTypeSize(ShaderDataType Type)
{
    switch (Type)
    {
        ...
        case ShaderDataType::eFloat2: return 4 * 2;
        case ShaderDataType::eFloat3: return 4 * 3;
        case ShaderDataType::eFloat4: return 4 * 4;

        case ShaderDataType::eMat3: return 4 * 3 * 3;
        case ShaderDataType::eMat4: return 4 * 4 * 4;

        case ShaderDataType::eInt: return 4;
        case ShaderDataType::eInt2: return 4 * 2;
        case ShaderDataType::eInt3: return 4 * 3;
        case ShaderDataType::eInt4: return 4 * 4;
...
struct VT_ENGINE_EXPORT BufferElement
{
    ...
    constexpr uint32_t GetElementType() const { return ComputeShaderDataElementCount(Type); }
};
